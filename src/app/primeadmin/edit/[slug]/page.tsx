    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-cyan-300/60">تعديل بيانات: {form.name}</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block text-sm text-cyan-300/70 mb-1">رسالة واتساب</label>
          <input
            type="text"
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-cyan-900/50">
          ...
          <Link href="/primeadmin" className="text-sm text-cyan-300/70 hover:text-white transition-colors">
            إلغاء
          </Link>
        </div>
      </form>
